...
pepcomposer_jobs_archive_dir = os.path.join(pepcomposer_jobs_dir,"archived_jobs")
...
# checking  paths
if os.path.exists(pepcomposer_path) is False:
    path_check_ok = False
if os.path.exists(pepcomposer_jobs_dir) is False:
    jobs_path_check_ok = False
if os.path.exists(pepcomposer_jobs_archive_dir) is False:
    if DEBUG_MODE is False:
        os.mkdir (pepcomposer_jobs_archive_dir,2775)
    else:
        print "Missing jobs archive in ", pepcomposer_jobs_archive_dir , ". Not creating dir."

if path_check_ok:
    # do pepcomposer stuff
    print "TODO"
else:
    if path_check_ok is False:
        print "ERROR!!! Pepcomposer directory not found in ", pepcomposer_path, "!"
    if jobs_path_check_ok is False:
        print "ERROR!!! Pepcomposer jobs directory not found in ", pepcomposer_jobs_dir, "!"


if found_in_examples ("1DXP_154_A_57058b2c3d4f3"):
    print "Job 1DXP_154_A_57058b2c3d4f3 is a sample, skipping."
else:
    print "Job 1DXP_154_A_57058b2c3d4f3 ready for processing"
